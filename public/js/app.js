...
var _explorer_index = {
  ...
  playlists_available: function playlists_available() {
    ...
    $("#explorer_map_location").html(playlist_copy); // var popupcopy = "<h2>You are here</h2>";
      ...
      $('#playlists_edit-location_form').on('submit', function (e) {
        ...
        xhr.onload = function () {
          ...
          $("#playlist_edit-location_list ul li a").click(function (e) {
            ...
            _this_actual.playlist_edit_load_map(_location, true); //alert("general location provide; please click for exact location");
